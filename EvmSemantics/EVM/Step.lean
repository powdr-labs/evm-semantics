...
5. **Gas hypothesis** — `Gas.baseCost s.executionEnv.fork op ≤ s.gasAvailable`. Passed
...
inductive Step : State → State → Prop
  ...
  | add (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_gas     : Gas.baseCost s.executionEnv.fork .ADD ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .ADD) h_gas).replaceStackAndIncrPC ((a + b) :: rest))
  ...
  | mul (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MUL ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .MUL) h_gas).replaceStackAndIncrPC ((a * b) :: rest))
  ...
  | sub (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SUB ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SUB) h_gas).replaceStackAndIncrPC ((a - b) :: rest))
  ...
  | div (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .DIV ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .DIV) h_gas).replaceStackAndIncrPC ((a / b) :: rest))
  ...
  | sdiv (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SDIV ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SDIV) h_gas).replaceStackAndIncrPC
  ...
  | mod (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MOD ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .MOD) h_gas).replaceStackAndIncrPC ((a % b) :: rest))
  ...
  | smod (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SMOD ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SMOD) h_gas).replaceStackAndIncrPC
  ...
  | addmod (s : State) (a b n : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .ADDMOD ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: n :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .ADDMOD) h_gas).replaceStackAndIncrPC
  ...
  | mulmod (s : State) (a b n : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MULMOD ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: n :: rest)
  ...
  | signextend (s : State) (b x : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SIGNEXTEND ≤ s.gasAvailable)
        (h_stack   : s.stack = b :: x :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SIGNEXTEND) h_gas).replaceStackAndIncrPC
  ...
  | lt (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .LT ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .LT) h_gas).replaceStackAndIncrPC
                  (UInt256.lt a b :: rest))
  ...
  | gt (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .GT ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .GT) h_gas).replaceStackAndIncrPC
                  (UInt256.gt a b :: rest))
  ...
  | slt (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SLT ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SLT) h_gas).replaceStackAndIncrPC
  ...
  | sgt (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SGT ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SGT) h_gas).replaceStackAndIncrPC
  ...
  | eq (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .EQ ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .EQ) h_gas).replaceStackAndIncrPC
                  (UInt256.eq a b :: rest))
  ...
  | iszero (s : State) (a : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .ISZERO ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .ISZERO) h_gas).replaceStackAndIncrPC
  ...
  | and (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .AND ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .AND) h_gas).replaceStackAndIncrPC
  ...
  | or (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .OR ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .OR) h_gas).replaceStackAndIncrPC
  ...
  | xor_ (s : State) (a b : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .XOR ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: b :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .XOR) h_gas).replaceStackAndIncrPC
  ...
  | not (s : State) (a : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .NOT ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .NOT) h_gas).replaceStackAndIncrPC
                  (UInt256.lnot a :: rest))
  ...
  | byte_ (s : State) (i x : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BYTE ≤ s.gasAvailable)
        (h_stack   : s.stack = i :: x :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BYTE) h_gas).replaceStackAndIncrPC
  ...
  | shl (s : State) (shift v : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SHL ≤ s.gasAvailable)
        (h_stack   : s.stack = shift :: v :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SHL) h_gas).replaceStackAndIncrPC
  ...
  | shr (s : State) (shift v : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SHR ≤ s.gasAvailable)
        (h_stack   : s.stack = shift :: v :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SHR) h_gas).replaceStackAndIncrPC
  ...
  | sar (s : State) (shift v : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SAR ≤ s.gasAvailable)
        (h_stack   : s.stack = shift :: v :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SAR) h_gas).replaceStackAndIncrPC
  ...
  | keccak256 (s : State) (offset size : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .KECCAK256 ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: size :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .KECCAK256) h_gas).canExpandMemory
                       offset.toNat size.toNat)
      : Step s
          (let bytes := MachineState.readPadded s.memory offset.toNat size.toNat
           ((s.consumeGas (Gas.baseCost s.executionEnv.fork .KECCAK256) h_gas).consumeMemExp
  ...
  | address (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .ADDRESS ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .ADDRESS) h_gas).replaceStackAndIncrPC
  ...
  | balance (s : State) (addr : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BALANCE ≤ s.gasAvailable)
        (h_stack   : s.stack = addr :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BALANCE) h_gas).replaceStackAndIncrPC
  ...
  | origin (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .ORIGIN ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .ORIGIN) h_gas).replaceStackAndIncrPC
  ...
  | caller (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CALLER ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .CALLER) h_gas).replaceStackAndIncrPC
  ...
  | callvalue (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CALLVALUE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .CALLVALUE) h_gas).replaceStackAndIncrPC
  ...
  | calldataload (s : State) (i : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CALLDATALOAD ≤ s.gasAvailable)
      ...
      : Step s
          (let bs := MachineState.readPadded s.executionEnv.calldata i.toNat 32
           ...
           (s.consumeGas (Gas.baseCost s.executionEnv.fork .CALLDATALOAD) h_gas).replaceStackAndIncrPC
  ...
  | calldatasize (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CALLDATASIZE ≤ s.gasAvailable)
  ...
  | calldatacopy (s : State) (destOff srcOff sz : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CALLDATACOPY ≤ s.gasAvailable)
  ...
  | codesize (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CODESIZE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .CODESIZE) h_gas).replaceStackAndIncrPC
  ...
  | codecopy (s : State) (destOff srcOff sz : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CODECOPY ≤ s.gasAvailable)
        (h_stack   : s.stack = destOff :: srcOff :: sz :: rest)
  ...
  | gasprice (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .GASPRICE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .GASPRICE) h_gas).replaceStackAndIncrPC
  ...
  | extcodesize (s : State) (addr : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .EXTCODESIZE ≤ s.gasAvailable)
        (h_stack   : s.stack = addr :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .EXTCODESIZE) h_gas).replaceStackAndIncrPC
  ...
  | extcodecopy (s : State) (addr destOff srcOff sz : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .EXTCODECOPY ≤ s.gasAvailable)
  ...
  | returndatasize (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .RETURNDATASIZE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .RETURNDATASIZE) h_gas).replaceStackAndIncrPC
  ...
  | returndatacopy (s : State) (destOff srcOff sz : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .RETURNDATACOPY ≤ s.gasAvailable)
        (h_stack   : s.stack = destOff :: srcOff :: sz :: rest)
  ...
  | extcodehash (s : State) (addr : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .EXTCODEHASH ≤ s.gasAvailable)
        (h_stack   : s.stack = addr :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .EXTCODEHASH) h_gas).replaceStackAndIncrPC
  ...
  | blockhash (s : State) (n : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BLOCKHASH ≤ s.gasAvailable)
        (h_stack   : s.stack = n :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BLOCKHASH) h_gas).replaceStackAndIncrPC
  ...
  | coinbase (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .COINBASE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .COINBASE) h_gas).replaceStackAndIncrPC
  ...
  | timestamp (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .TIMESTAMP ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .TIMESTAMP) h_gas).replaceStackAndIncrPC
  ...
  | number (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .NUMBER ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .NUMBER) h_gas).replaceStackAndIncrPC
  ...
  | prevrandao (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .PREVRANDAO ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .PREVRANDAO) h_gas).replaceStackAndIncrPC
  ...
  | gaslimit (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .GASLIMIT ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .GASLIMIT) h_gas).replaceStackAndIncrPC
  ...
  | chainid (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .CHAINID ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .CHAINID) h_gas).replaceStackAndIncrPC
  ...
  | selfbalance (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SELFBALANCE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SELFBALANCE) h_gas).replaceStackAndIncrPC
  ...
  | basefee (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BASEFEE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BASEFEE) h_gas).replaceStackAndIncrPC
  ...
  | blobhash (s : State) (i : UInt256) (rest : List UInt256) (h : UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BLOBHASH ≤ s.gasAvailable)
        (h_stack   : s.stack = i :: rest)
        (h_get     : s.executionEnv.blobVersionedHashes[i.toNat]? = some h)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BLOBHASH) h_gas).replaceStackAndIncrPC
                  (h :: rest))
  ...
  | blobbasefee (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .BLOBBASEFEE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .BLOBBASEFEE) h_gas).replaceStackAndIncrPC
  ...
  | pop (s : State) (a : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .POP ≤ s.gasAvailable)
        (h_stack   : s.stack = a :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .POP) h_gas).replaceStackAndIncrPC rest)
  ...
  | push0 (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.Push ⟨0, by decide⟩) ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.Push ⟨0, by decide⟩)) h_gas).replaceStackAndIncrPC
                  (⟨0⟩ :: s.stack))
  ...
  | pushN (s : State) (k : Fin 33) (data : UInt256) (immWidth : Nat)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.Push ⟨k, k.isLt⟩) ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.Push ⟨k, k.isLt⟩)) h_gas).replaceStackAndIncrPC
  ...
  | dup (s : State) (n : Fin 16) (v : UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.Dup ⟨n⟩) ≤ s.gasAvailable)
        (h_get     : s.stack[n.val]? = some v)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.Dup ⟨n⟩)) h_gas).replaceStackAndIncrPC (v :: s.stack))
  ...
  | swap (s : State) (n : Fin 16) (stk' : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.Swap ⟨n⟩) ≤ s.gasAvailable)
        (h_swap    : s.stack.exchange 0 (n.val + 1) = some stk')
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.Swap ⟨n⟩)) h_gas).replaceStackAndIncrPC stk')
  ...
  | mload (s : State) (offset : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MLOAD ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .MLOAD) h_gas).canExpandMemory
                       offset.toNat 32)
        (h_load    : MachineState.mload
                       ((s.consumeGas (Gas.baseCost s.executionEnv.fork .MLOAD) h_gas).consumeMemExp
                          offset.toNat 32 h_mem).toMachineState offset = (v, μ'))
      : Step s ({ ((s.consumeGas (Gas.baseCost s.executionEnv.fork .MLOAD) h_gas).consumeMemExp
  ...
  | mstore (s : State) (offset value : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MSTORE ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: value :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .MSTORE) h_gas).canExpandMemory
                       offset.toNat 32)
      : Step s
          (let s'' := (s.consumeGas (Gas.baseCost s.executionEnv.fork .MSTORE) h_gas).consumeMemExp
  ...
  | mstore8 (s : State) (offset value : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MSTORE8 ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: value :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .MSTORE8) h_gas).canExpandMemory
                       offset.toNat 1)
      : Step s
          (let s'' := (s.consumeGas (Gas.baseCost s.executionEnv.fork .MSTORE8) h_gas).consumeMemExp
  ...
  | msize (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MSIZE ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .MSIZE) h_gas).replaceStackAndIncrPC
  ...
  | mcopy (s : State) (destOff srcOff sz : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .MCOPY ≤ s.gasAvailable)
        (h_stack   : s.stack = destOff :: srcOff :: sz :: rest)
  ...
  | sload (s : State) (key : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .SLOAD ≤ s.gasAvailable)
        (h_stack   : s.stack = key :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SLOAD) h_gas).replaceStackAndIncrPC
  ...
  /-- SSTORE: pop key, value; write storage[key] := value. Requires
      ...
      `Gas.sstoreCost s.executionEnv.fork original current value` on top of the (zero) static
  ...
  | sstore (s : State) (key value : UInt256) (rest : List UInt256)
      ...
      : Step s
          (let addr     := s.executionEnv.codeOwner
           ...
           { ((s.consumeGas (Gas.baseCost s.executionEnv.fork .SSTORE) h_gas).consumeGas cost h_dyn_gas)
               with accountMap := σ' }
  ...
  | tload (s : State) (key : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .TLOAD ≤ s.gasAvailable)
        (h_stack   : s.stack = key :: rest)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .TLOAD) h_gas).replaceStackAndIncrPC
  ...
  | tstore (s : State) (key value : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_perm    : s.executionEnv.permitStateMutation = true)
        (h_gas     : Gas.baseCost s.executionEnv.fork .TSTORE ≤ s.gasAvailable)
        (h_stack   : s.stack = key :: value :: rest)
      : Step s
          (let addr := s.executionEnv.codeOwner
           let acc  := s.accountMap addr
           ...
           let σ'   := s.accountMap.set addr acc'
           { (s.consumeGas (Gas.baseCost s.executionEnv.fork .TSTORE) h_gas) with accountMap := σ' }
             |>.replaceStackAndIncrPC rest)
  ...
  | jump (s : State) (dest : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .JUMP ≤ s.gasAvailable)
        (h_stack   : s.stack = dest :: rest)
        (h_valid   : Decode.decodeAt s.executionEnv.code dest.toNat
                       = some (.JUMPDEST, none))
      : Step s { (s.consumeGas (Gas.baseCost s.executionEnv.fork .JUMP) h_gas) with pc := dest, stack := rest }
  ...
  | jumpi_taken (s : State) (dest cond : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .JUMPI ≤ s.gasAvailable)
        (h_stack   : s.stack = dest :: cond :: rest)
        (h_cond    : UInt256.isTrue cond)
        (h_valid   : Decode.decodeAt s.executionEnv.code dest.toNat
                       = some (.JUMPDEST, none))
      : Step s { (s.consumeGas (Gas.baseCost s.executionEnv.fork .JUMPI) h_gas) with pc := dest, stack := rest }
  ...
  | jumpi_notTaken (s : State) (dest cond : UInt256) (rest : List UInt256)
        ...
        (h_stack   : s.stack = dest :: cond :: rest)
        (h_cond    : ¬ UInt256.isTrue cond)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .JUMPI) h_gas).replaceStackAndIncrPC rest)

  | pc (s : State)
        (arg       : Option (UInt256 × Nat))
        (h_op      : s.decoded = some (.PC, arg))
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .PC ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .PC) h_gas).replaceStackAndIncrPC
                  (s.pc :: s.stack))
  ...
  | gas (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .GAS ≤ s.gasAvailable)
      : Step s
          (let s' := s.consumeGas (Gas.baseCost s.executionEnv.fork .GAS) h_gas
  ...
  | jumpdest (s : State)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .JUMPDEST ≤ s.gasAvailable)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork .JUMPDEST) h_gas).incrPC)
  ...
  | return_ (s : State) (offset size : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .RETURN ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: size :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .RETURN) h_gas).canExpandMemory
                       offset.toNat size.toNat)
      : Step s
          (let bs := MachineState.readPadded s.memory offset.toNat size.toNat
           let s'' := (s.consumeGas (Gas.baseCost s.executionEnv.fork .RETURN) h_gas).consumeMemExp
  ...
  | revert (s : State) (offset size : UInt256) (rest : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork .REVERT ≤ s.gasAvailable)
        (h_stack   : s.stack = offset :: size :: rest)
        (h_mem     : (s.consumeGas (Gas.baseCost s.executionEnv.fork .REVERT) h_gas).canExpandMemory
                       offset.toNat size.toNat)
      : Step s
          (let bs := MachineState.readPadded s.memory offset.toNat size.toNat
           let s'' := (s.consumeGas (Gas.baseCost s.executionEnv.fork .REVERT) h_gas).consumeMemExp
                        offset.toNat size.toNat h_mem
  ...
  | log (s : State) (n : Fin 5) (offset size : UInt256)
        ...
        (h_running  : s.halt = .Running)
        (h_perm     : s.executionEnv.permitStateMutation = true)
        (h_gas      : Gas.baseCost s.executionEnv.fork (.Log ⟨n⟩) ≤ s.gasAvailable)
  ...
  | dupN (s : State) (n : Fin 256) (v : UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.DupN ⟨n⟩) ≤ s.gasAvailable)
        (h_get     : s.stack[n.val]? = some v)
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.DupN ⟨n⟩)) h_gas).replaceStackAndIncrPC
                  (v :: s.stack) (pcΔ := 2))
  ...
  | swapN (s : State) (n : Fin 256) (stk' : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.SwapN ⟨n⟩) ≤ s.gasAvailable)
        (h_swap    : s.stack.exchange 0 (n.val + 1) = some stk')
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.SwapN ⟨n⟩)) h_gas).replaceStackAndIncrPC
                  stk' (pcΔ := 2))
  ...
  | exchange (s : State) (b : Fin 256) (stk' : List UInt256)
        ...
        (h_running : s.halt = .Running)
        (h_gas     : Gas.baseCost s.executionEnv.fork (.Exchange ⟨b⟩) ≤ s.gasAvailable)
        (h_swap    : s.stack.exchange
                      (b.val >>> 4 + 1)
                      ((b.val &&& 0xf) + 1) = some stk')
      : Step s ((s.consumeGas (Gas.baseCost s.executionEnv.fork (.Exchange ⟨b⟩)) h_gas).replaceStackAndIncrPC
                  stk' (pcΔ := 2))
  ...
  -- hypotheses (`Gas.baseCost s.executionEnv.fork op ≤ gas` vs. `gas < Gas.baseCost s.executionEnv.fork op`, etc.).
  --
