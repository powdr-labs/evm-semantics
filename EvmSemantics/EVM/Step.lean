...
inductive Step : State → State → Prop
  ...
  | addmod (s : State) (a b n : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.ADDMOD, none))
        (h_running : s.halt = .Running)
  ...
  | mulmod (s : State) (a b n : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.MULMOD, none))
        (h_running : s.halt = .Running)
  ...
  | signextend (s : State) (b x : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.SIGNEXTEND, none))
        (h_running : s.halt = .Running)
  ...
  | iszero (s : State) (a : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.ISZERO, none))
        (h_running : s.halt = .Running)
  ...
  | keccak256 (s : State) (offset size : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.KECCAK256, none))
        (h_running : s.halt = .Running)
  ...
  | address (s : State)
        (h_op      : s.decoded = some (.ADDRESS, none))
        (h_running : s.halt = .Running)
  ...
  | balance (s : State) (addr : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.BALANCE, none))
        (h_running : s.halt = .Running)
  ...
  | origin (s : State)
        (h_op      : s.decoded = some (.ORIGIN, none))
        (h_running : s.halt = .Running)
  ...
  | caller (s : State)
        (h_op      : s.decoded = some (.CALLER, none))
        (h_running : s.halt = .Running)
  ...
  | callvalue (s : State)
        (h_op      : s.decoded = some (.CALLVALUE, none))
        (h_running : s.halt = .Running)
  ...
  | calldataload (s : State) (i : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.CALLDATALOAD, none))
        (h_running : s.halt = .Running)
  ...
  | calldatasize (s : State)
        (h_op      : s.decoded = some (.CALLDATASIZE, none))
        (h_running : s.halt = .Running)
  ...
  | calldatacopy (s : State) (destOff srcOff sz : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.CALLDATACOPY, none))
        (h_running : s.halt = .Running)
  ...
  | codesize (s : State)
        (h_op      : s.decoded = some (.CODESIZE, none))
        (h_running : s.halt = .Running)
  ...
  | codecopy (s : State) (destOff srcOff sz : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.CODECOPY, none))
        (h_running : s.halt = .Running)
  ...
  | gasprice (s : State)
        (h_op      : s.decoded = some (.GASPRICE, none))
        (h_running : s.halt = .Running)
  ...
  | extcodesize (s : State) (addr : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.EXTCODESIZE, none))
        (h_running : s.halt = .Running)
  ...
  | extcodecopy (s : State) (addr destOff srcOff sz : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.EXTCODECOPY, none))
        (h_running : s.halt = .Running)
  ...
  | returndatasize (s : State)
        (h_op      : s.decoded = some (.RETURNDATASIZE, none))
        (h_running : s.halt = .Running)
  ...
  | returndatacopy (s : State) (destOff srcOff sz : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.RETURNDATACOPY, none))
        (h_running : s.halt = .Running)
  ...
  | extcodehash (s : State) (addr : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.EXTCODEHASH, none))
        (h_running : s.halt = .Running)
  ...
  | blockhash (s : State) (n : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.BLOCKHASH, none))
        (h_running : s.halt = .Running)
  ...
  | coinbase (s : State)
        (h_op      : s.decoded = some (.COINBASE, none))
        (h_running : s.halt = .Running)
  ...
  | timestamp (s : State)
        (h_op      : s.decoded = some (.TIMESTAMP, none))
        (h_running : s.halt = .Running)
  ...
  | number (s : State)
        (h_op      : s.decoded = some (.NUMBER, none))
        (h_running : s.halt = .Running)
  ...
  | prevrandao (s : State)
        (h_op      : s.decoded = some (.PREVRANDAO, none))
        (h_running : s.halt = .Running)
  ...
  | gaslimit (s : State)
        (h_op      : s.decoded = some (.GASLIMIT, none))
        (h_running : s.halt = .Running)
  ...
  | chainid (s : State)
        (h_op      : s.decoded = some (.CHAINID, none))
        (h_running : s.halt = .Running)
  ...
  | selfbalance (s : State)
        (h_op      : s.decoded = some (.SELFBALANCE, none))
        (h_running : s.halt = .Running)
  ...
  | basefee (s : State)
        (h_op      : s.decoded = some (.BASEFEE, none))
        (h_running : s.halt = .Running)
  ...
  | blobhash (s : State) (i : UInt256) (rest : Stack UInt256) (h : UInt256)
        (h_op      : s.decoded = some (.BLOBHASH, none))
        (h_running : s.halt = .Running)
  ...
  | blobbasefee (s : State)
        (h_op      : s.decoded = some (.BLOBBASEFEE, none))
        (h_running : s.halt = .Running)
  ...
  /-- PUSH0: push `0`. -/
  | push0 (s : State)
        (h_op      : s.decoded = some (.Push ⟨0, by decide⟩, none))
        (h_running : s.halt = .Running)
  ...
  /-- PUSHk (k ≥ 1): push the immediate-decoded value. PC advances by `k + 1`. -/
  | pushN (s : State) (k : Fin 33) (data : UInt256)
        (h_k_pos   : 0 < k.val)
        (h_op      : s.decoded = some (.Push ⟨k, k.isLt⟩, some (data, k.val)))
        (h_running : s.halt = .Running)
        (h_gas     : Gas.cost (.Push ⟨k, k.isLt⟩) ≤ s.gasAvailable.toNat)
      : Step s ((s.consumeGas (Gas.cost (.Push ⟨k, k.isLt⟩)) h_gas).replaceStackAndIncrPC
                  (data :: s.stack) (pcΔ := k.val + 1))

  /-- DUPn: copy `stack[n]` (0-indexed from top) to the top. -/
  | dup (s : State) (n : Fin 16) (v : UInt256)
        (h_op      : s.decoded = some (.Dup ⟨n⟩, none))
        (h_running : s.halt = .Running)
  ...
  | swap (s : State) (n : Fin 16) (stk' : Stack UInt256)
        (h_op      : s.decoded = some (.Swap ⟨n⟩, none))
        (h_running : s.halt = .Running)
  ...
  | mload (s : State) (offset : UInt256) (rest : Stack UInt256)
        ...
        (h_op      : s.decoded = some (.MLOAD, none))
        (h_running : s.halt = .Running)
  ...
  | mstore (s : State) (offset value : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.MSTORE, none))
        (h_running : s.halt = .Running)
  ...
  | mstore8 (s : State) (offset value : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.MSTORE8, none))
        (h_running : s.halt = .Running)
  ...
  | msize (s : State)
        (h_op      : s.decoded = some (.MSIZE, none))
        (h_running : s.halt = .Running)
  ...
  | mcopy (s : State) (destOff srcOff sz : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.MCOPY, none))
        (h_running : s.halt = .Running)
  ...
  | sload (s : State) (key : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.SLOAD, none))
        (h_running : s.halt = .Running)
  ...
  | sstore (s : State) (key value : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.SSTORE, none))
        (h_running : s.halt = .Running)
  ...
  | tload (s : State) (key : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.TLOAD, none))
        (h_running : s.halt = .Running)
  ...
  | tstore (s : State) (key value : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.TSTORE, none))
        (h_running : s.halt = .Running)
        (h_perm    : s.executionEnv.permitStateMutation = true)
  ...
  | jumpi_taken (s : State) (dest cond : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.JUMPI, none))
        (h_running : s.halt = .Running)
  ...
  | jumpdest (s : State)
        (h_op      : s.decoded = some (.JUMPDEST, none))
        (h_running : s.halt = .Running)
  ...
  | revert (s : State) (offset size : UInt256) (rest : Stack UInt256)
        (h_op      : s.decoded = some (.REVERT, none))
        (h_running : s.halt = .Running)
  ...
  | log (s : State) (n : Fin 5) (offset size : UInt256)
        ...
        (h_op       : s.decoded = some (.Log ⟨n⟩, none))
        (h_running  : s.halt = .Running)
        (h_perm     : s.executionEnv.permitStateMutation = true)
  ...
  | dupN (s : State) (n : Fin 256) (v : UInt256)
        (h_op      : s.decoded = some (.DupN ⟨n⟩, none))
        (h_running : s.halt = .Running)
  ...
  | swapN (s : State) (n : Fin 256) (stk' : Stack UInt256)
        (h_op      : s.decoded = some (.SwapN ⟨n⟩, none))
        (h_running : s.halt = .Running)
  ...
  | exchange (s : State) (b : Fin 256) (stk' : Stack UInt256)
        (h_op      : s.decoded = some (.Exchange ⟨b⟩, none))
        (h_running : s.halt = .Running)
  ...
  | invalidOpcode (s : State)
        (h_running : s.halt = .Running)
        (h_op      : s.decoded = some (.INVALID, none))
      : Step s (s.haltWith .InvalidInstruction)
